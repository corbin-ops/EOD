...
const SESSION_COOKIE_NAME = "dew-claw-session";
const SESSION_NAMESPACE = "dew-claw:shared-auth";
...
function getAuthSecret() {
  return process.env.AUTH_SECRET?.trim() || getDashboardPassword();
}

export function isAuthConfigured() {
  return Boolean(getDashboardPassword() && getAuthSecret());
}
